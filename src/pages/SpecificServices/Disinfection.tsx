        ...
        <br/>
            ...
            <br />
                <div className="row">
                    ...
                    <h2 style={{color:"#f4623a"}}>Απολύμανση - Απεντόμωση - Μυοκτονία</h2>
                    <p>
...
Δώστε μας τηλεφωνικά τα έξοδα σας, και μέσα σε 24 ώρες, θα σας αποστείλουμε τα κοινόχρηστα όπου εσείς μας ζητήσετε</i></strong></p>  
                ...
                <div className="row">
                    <div className="col-sm-4">
                        <br />
                        <br />
                        <AiOutlineBug size="150" style={{color:"#f4623a"}}/>
                    </div>
                    <div className="col-sm-8">
                    <h2 style={{color:"#f4623a"}}>Επιστημονική αντιμετώπιση σε κάθε σας ανάγκη!</h2>
                    <p>
                ...
                <div className="container well-sm">
                    <h2 style={{color:"#f4623a"}}>Συχνές ερωτήσεις και οι απαντήσεις τους:</h2>
                    <dl className="terms-list text-left" >
                        <dt className="heading-5" style={{color:"#f4623a"}}>ΠΩΣ ΓΙΝΕΤΑΙ Η ΑΠΕΝΤΟΜΩΣΗ ΓΙΑ ΚΑΤΣΑΡΙΔΕΣ;</dt>
                        <dd>
                        ...
                        <dt className="heading-5" style={{color:"#f4623a"}}>ΜΕ ΜΙΑ ΑΠΕΝΤΟΜΩΣΗ ΕΧΩ ΗΣΥΧΑΣΕΙ ΜΙΑ ΓΙΑ ΠΑΝΤΑ ΑΠΟ ΤΙΣ ΚΑΤΣΑΡΙΔΕΣ;</dt>
                        <dd>
                        ...
                        <dt className="heading-5" style={{color:"#f4623a"}}>ΤΑ ΦΑΡΜΑΚΑ ΠΟΥ ΧΡΗΣΙΜΟΠΟΙΟΥΝΤΑΙ ΣΤΙΣ ΑΠΟΛΥΜΑΝΣΕΙΣ ΕΙΝΑΙ ΒΛΑΒΕΡΑ ΓΙΑ ΤΟΝ ΑΝΘΡΩΠΟ ΚΑΙ ΤΑ ΚΑΤΟΙΚΙΔΙΑ;</dt>
                        <dd>
                        ...
                        <dt className="heading-5" style={{color:"#f4623a"}}>ΚΑΘΕ ΠΟΤΕ ΠΡΕΠΕΙ ΝΑ ΚΑΝΩ ΑΠΕΝΤΟΜΩΣΗ ΓΙΑ ΚΑΤΣΑΡΙΔΕΣ;</dt>
                        <dd>
                        ...
                        <dt className="heading-5" style={{color:"#f4623a"}}>ΘΑ ΠΡΕΠΕΙ ΝΑ ΠΡΟΣΕΞΩ ΚΑΤΙ ΜΕΤΑ ΤΗΝ ΑΠΕΝΤΟΜΩΣΗ;</dt>
                        <dd>
                        ...
                        <dt className="heading-5" style={{color:"#f4623a"}}>ΤΙ ΕΙΝΑΙ Η ΑΝΤΙΜΕΤΩΠΙΣΗ ΚΑΤΣΑΡΙΔΩΝ ΜΕ GEL ΚΑΙ ΣΕ ΠΟΙΕΣ ΠΕΡΙΠΤΩΣΕΙΣ ΧΡΗΣΙΜΟΠΟΙΕΙΤΑΙ;</dt>
                        <dd>
                        ...
                        <dt className="heading-5" style={{color:"#f4623a" }}>ΤΙ ΕΙΝΑΙ ΚΑΙ ΠΩΣ ΓΙΝΕΤΑΙ ΜΙΑ ΜΥΟΚΤΟΝΙΑ;</dt>
                        <dd>
